    ...
    <div class="article-contribution">
        ...
        <div class="form-box animate__animated animate__bounceIn" v-show="form.isShow">
            ...
            <el-form :model="form" ref="ruleFormRef" label-width="120px" label-position="left" :rules="rules.articleContributionRules">
                ...
                <el-button size="small" type="primary" @click="useSaveData(form,ruleFormRef,router,uploadFileformation,uploadCoveration)">提交</el-button>
            </el-form>
        </div>
        <!-- 上传组件 -->
...
import { useArticleContributionProp, useHandleFileMethod, useHandleCoverMethod, useInit, userLabelHandlMethod , useSaveData ,useRules } from '@/hooks/creation/contribute/contributePage/useArticleContribution';
import { onMounted } from 'vue';
components: {
    QuillEditor
}

const { myQuillEditor, form, options, uploadFileformation, uploadCoveration, uploadRef, uploadBtnRef, uploadProgressRef, colors, labelInputRef ,ruleFormRef,router} = useArticleContributionProp()
