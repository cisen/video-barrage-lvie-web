    ...
    <div class="video-page">
        ...
        <div class="video-content">
            ...
            <div class="content-right">
                <div class="user-card">
                    <div class="card-left">
                        <div class="avatar"> <el-avatar :size="60" :src="videoInfo?.videoInfo?.creatorInfo?.avatar" />
                        </div>
                    </div>
                    ...
                    <div class="card-right">
                        ...
                        <div class="signature">
                            <VueEllipsis3
                                :text="videoInfo?.videoInfo?.creatorInfo?.signature ? videoInfo.videoInfo.creatorInfo.signature : ''">
