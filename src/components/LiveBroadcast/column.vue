    ...
    <div class="column">
        ...
        <div class="column-list">
            ...
            <div :class="{ mouseover: item.is_stay, mouseleave: !item.is_stay }" class="column-item shadow-box "
                @mouseover="mouseOver(item)" @mouseleave="mouseleave(item)" v-for="item in columnList" :key="item.id"
                @click="jumpArticle(item.id)">
                <div class="item-image">
                    <img :src="item.cover" class="el-image__inner" style="object-fit: cover;">
                </div>
                <div class="item-text">
                    <div class="post-meta">
